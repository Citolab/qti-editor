/**
 * Phase 1 snapshot fixture — DOM COMPOSE PIPELINE BASELINE
 *
 * Locks the CURRENT byte-for-byte output of `buildAssessmentItemXml` from
 * @qti-editor/qti-core. This is the DOM-based compose pipeline that:
 *   - strips non-QTI attrs (`correct-response`, `score`, `case-sensitive`,
 *     `area-mappings`) from interaction source elements,
 *   - mirrors them to `data-*` on the normalized element via
 *     `preserveEditorDataAttributes`,
 ...
 *
 * For the parallel regex-pipeline baseline driven by `createQtiPackageFromItems`,
 * see: packages/qti/roundtrip-export/src/non-qti-mirror-regex.snapshot.test.ts
 *
 * This file is the regression detector for the
 * `plans/unify-non-qti-attribute-metadata.md` migration. Phase 3 changes this
 * compose pipeline; each subsequent phase must keep these snapshots
 * byte-identical. If anything diffs, the migration broke the wire format —
...
describe('non-QTI data-* mirror snapshots — DOM compose pipeline (Phase 1 baseline)', () => {
  it('choice interaction: strips correct-response + score and mirrors to data-*', () => {
    ...
    expect(xml).toMatchInlineSnapshot(`
      "<qti-assessment-item xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.imsglobal.org/xsd/imsqtiasi_v3p0 https://purl.imsglobal.org/spec/qti/v3p0/schema/xsd/imsqti_asiv3p0p1_v1p0.xsd" identifier="snap-choice" title="snap-choice" adaptive="false" time-dependent="false" xml:lang="en"><qti-response-declaration identifier="RESPONSE" cardinality="single" base-type="identifier"><qti-correct-response><qti-value>choice-a</qti-value></qti-correct-response></qti-response-declaration><qti-outcome-declaration identifier="SCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>0</qti-value></qti-default-value></qti-outcome-declaration><qti-outcome-declaration identifier="MAXSCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>2</qti-value></qti-default-value></qti-outcome-declaration><qti-item-body xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" data-identifier="snap-choice" data-title="snap-choice" data-lab-editor-version="1">
              <qti-choice-interaction response-identifier="RESPONSE" max-choices="1" data-correct-response="choice-a" data-score="2">
                <qti-simple-choice identifier="choice-a">A</qti-simple-choice>
                <qti-simple-choice identifier="choice-b">B</qti-simple-choice>
              </qti-choice-interaction>
  ...
  it('inline-choice interaction: strips correct-response + score and mirrors to data-*', () => {
    ...
    expect(xml).toMatchInlineSnapshot(`
      "<qti-assessment-item xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.imsglobal.org/xsd/imsqtiasi_v3p0 https://purl.imsglobal.org/spec/qti/v3p0/schema/xsd/imsqti_asiv3p0p1_v1p0.xsd" identifier="snap-inline-choice" title="snap-inline-choice" adaptive="false" time-dependent="false" xml:lang="en"><qti-response-declaration identifier="RESPONSE" cardinality="single" base-type="identifier"><qti-correct-response><qti-value>ic-a</qti-value></qti-correct-response></qti-response-declaration><qti-outcome-declaration identifier="SCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>0</qti-value></qti-default-value></qti-outcome-declaration><qti-outcome-declaration identifier="MAXSCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>1</qti-value></qti-default-value></qti-outcome-declaration><qti-item-body xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" data-identifier="snap-inline-choice" data-title="snap-inline-choice" data-lab-editor-version="1">
              <p>Pick:
                <qti-inline-choice-interaction response-identifier="RESPONSE" data-correct-response="ic-a" data-score="1">
                  <qti-inline-choice identifier="ic-a">A</qti-inline-choice>
                  <qti-inline-choice identifier="ic-b">B</qti-inline-choice>
                </qti-inline-choice-interaction>
              </p>
  ...
  it('text-entry interaction: strips correct-response + score + case-sensitive and mirrors to data-*', () => {
    ...
    expect(xml).toMatchInlineSnapshot(`
      "<qti-assessment-item xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.imsglobal.org/xsd/imsqtiasi_v3p0 https://purl.imsglobal.org/spec/qti/v3p0/schema/xsd/imsqti_asiv3p0p1_v1p0.xsd" identifier="snap-text-entry" title="snap-text-entry" adaptive="false" time-dependent="false" xml:lang="en"><qti-response-declaration identifier="RESPONSE" cardinality="single" base-type="string"><qti-correct-response><qti-value>alpha</qti-value></qti-correct-response><qti-mapping default-value="0"><qti-map-entry map-key="alpha" mapped-value="3" case-sensitive="true"/><qti-map-entry map-key="beta" mapped-value="3" case-sensitive="true"/></qti-mapping></qti-response-declaration><qti-outcome-declaration identifier="SCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>0</qti-value></qti-default-value></qti-outcome-declaration><qti-outcome-declaration identifier="MAXSCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>3</qti-value></qti-default-value></qti-outcome-declaration><qti-item-body xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" data-identifier="snap-text-entry" data-title="snap-text-entry" data-lab-editor-version="1">
              <p>
                <qti-text-entry-interaction response-identifier="RESPONSE" data-correct-response="alpha,beta" data-score="3" data-case-sensitive="true"/>
              </p>
  ...
  it('extended-text interaction: strips correct-response, mirrors to data-*, synthesizes <qti-rubric-block>', () => {
    ...
    expect(xml).toMatchInlineSnapshot(`
      "<qti-assessment-item xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.imsglobal.org/xsd/imsqtiasi_v3p0 https://purl.imsglobal.org/spec/qti/v3p0/schema/xsd/imsqti_asiv3p0p1_v1p0.xsd" identifier="snap-extended-text" title="snap-extended-text" adaptive="false" time-dependent="false" xml:lang="en"><qti-response-declaration identifier="EXTENDED" cardinality="single" base-type="string"/><qti-outcome-declaration identifier="SCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>0</qti-value></qti-default-value></qti-outcome-declaration><qti-outcome-declaration identifier="MAXSCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>4</qti-value></qti-default-value></qti-outcome-declaration><qti-item-body xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" data-identifier="snap-extended-text" data-title="snap-extended-text" data-lab-editor-version="1">
              <qti-extended-text-interaction response-identifier="EXTENDED" expected-lines="6" data-correct-response="Model answer" data-score="4"/><qti-rubric-block view="scorer" use="scoring"><qti-content-body><div><p>Model answer</p></div></qti-content-body></qti-rubric-block>
  ...
  it('associate interaction: strips correct-response + score and mirrors to data-*', () => {
    ...
    expect(xml).toMatchInlineSnapshot(`
      "<qti-assessment-item xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.imsglobal.org/xsd/imsqtiasi_v3p0 https://purl.imsglobal.org/spec/qti/v3p0/schema/xsd/imsqti_asiv3p0p1_v1p0.xsd" identifier="snap-associate" title="snap-associate" adaptive="false" time-dependent="false" xml:lang="en"><qti-response-declaration identifier="RESPONSE" cardinality="single" base-type="identifier"><qti-correct-response><qti-value>a b</qti-value></qti-correct-response></qti-response-declaration><qti-outcome-declaration identifier="SCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>0</qti-value></qti-default-value></qti-outcome-declaration><qti-outcome-declaration identifier="MAXSCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>2</qti-value></qti-default-value></qti-outcome-declaration><qti-item-body xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" data-identifier="snap-associate" data-title="snap-associate" data-lab-editor-version="1">
              <qti-associate-interaction response-identifier="RESPONSE" max-associations="1" data-correct-response="a b" data-score="2">
                <qti-simple-associable-choice identifier="a" match-max="1">A</qti-simple-associable-choice>
                <qti-simple-associable-choice identifier="b" match-max="1">B</qti-simple-associable-choice>
              </qti-associate-interaction>
            </qti-item-body><qti-response-processing template="https://purl.imsglobal.org/spec/qti/v3p0/rptemplates/map_response"/></qti-assessment-item>"
  ...
  it('hottext interaction: strips correct-response + score and mirrors to data-*', () => {
    ...
    expect(xml).toMatchInlineSnapshot(`
      "<qti-assessment-item xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.imsglobal.org/xsd/imsqtiasi_v3p0 https://purl.imsglobal.org/spec/qti/v3p0/schema/xsd/imsqti_asiv3p0p1_v1p0.xsd" identifier="snap-hottext" title="snap-hottext" adaptive="false" time-dependent="false" xml:lang="en"><qti-response-declaration identifier="RESPONSE" cardinality="single" base-type="identifier"><qti-correct-response><qti-value>ht-a</qti-value></qti-correct-response></qti-response-declaration><qti-outcome-declaration identifier="SCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>0</qti-value></qti-default-value></qti-outcome-declaration><qti-outcome-declaration identifier="MAXSCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>2</qti-value></qti-default-value></qti-outcome-declaration><qti-item-body xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" data-identifier="snap-hottext" data-title="snap-hottext" data-lab-editor-version="1">
              <qti-hottext-interaction response-identifier="RESPONSE" max-choices="1" data-correct-response="ht-a" data-score="2">
                <p>
                  Select <qti-hottext identifier="ht-a">this</qti-hottext> or <qti-hottext identifier="ht-b">that</qti-hottext>.
                </p>
              </qti-hottext-interaction>
  ...
  it('match interaction: strips correct-response + score and mirrors to data-*', () => {
    ...
    expect(xml).toMatchInlineSnapshot(`
      "<qti-assessment-item xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.imsglobal.org/xsd/imsqtiasi_v3p0 https://purl.imsglobal.org/spec/qti/v3p0/schema/xsd/imsqti_asiv3p0p1_v1p0.xsd" identifier="snap-match" title="snap-match" adaptive="false" time-dependent="false" xml:lang="en"><qti-response-declaration identifier="RESPONSE" cardinality="single" base-type="identifier"><qti-correct-response><qti-value>a x</qti-value></qti-correct-response></qti-response-declaration><qti-outcome-declaration identifier="SCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>0</qti-value></qti-default-value></qti-outcome-declaration><qti-outcome-declaration identifier="MAXSCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>2</qti-value></qti-default-value></qti-outcome-declaration><qti-item-body xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" data-identifier="snap-match" data-title="snap-match" data-lab-editor-version="1">
              <qti-match-interaction response-identifier="RESPONSE" max-associations="1" data-correct-response="a x" data-score="2">
                <qti-simple-match-set>
                  <qti-simple-associable-choice identifier="a" match-max="1">A</qti-simple-associable-choice>
                </qti-simple-match-set>
                <qti-simple-match-set>
  ...
  it('gap-match interaction: strips correct-response + score and mirrors to data-*', () => {
    ...
    expect(xml).toMatchInlineSnapshot(`
      "<qti-assessment-item xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.imsglobal.org/xsd/imsqtiasi_v3p0 https://purl.imsglobal.org/spec/qti/v3p0/schema/xsd/imsqti_asiv3p0p1_v1p0.xsd" identifier="snap-gap-match" title="snap-gap-match" adaptive="false" time-dependent="false" xml:lang="en"><qti-response-declaration identifier="RESPONSE" cardinality="multiple" base-type="directedPair"><qti-correct-response><qti-value>g1 gap-a</qti-value></qti-correct-response></qti-response-declaration><qti-outcome-declaration identifier="SCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>0</qti-value></qti-default-value></qti-outcome-declaration><qti-outcome-declaration identifier="MAXSCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>2</qti-value></qti-default-value></qti-outcome-declaration><qti-item-body xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" data-identifier="snap-gap-match" data-title="snap-gap-match" data-lab-editor-version="1">
              <qti-gap-match-interaction response-identifier="RESPONSE" max-associations="1" data-correct-response="g1 gap-a" data-score="2">
                <qti-gap-text identifier="g1" match-max="1">Word</qti-gap-text>
                <p>Fill: <qti-gap identifier="gap-a"/></p>
              </qti-gap-match-interaction>
            </qti-item-body><qti-response-processing template="https://purl.imsglobal.org/spec/qti/v3p0/rptemplates/map_response"/></qti-assessment-item>"
  ...
  it('order interaction: strips correct-response + score and mirrors to data-*', () => {
    ...
    expect(xml).toMatchInlineSnapshot(`
      "<qti-assessment-item xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.imsglobal.org/xsd/imsqtiasi_v3p0 https://purl.imsglobal.org/spec/qti/v3p0/schema/xsd/imsqti_asiv3p0p1_v1p0.xsd" identifier="snap-order" title="snap-order" adaptive="false" time-dependent="false" xml:lang="en"><qti-response-declaration identifier="RESPONSE" cardinality="ordered" base-type="identifier"><qti-correct-response><qti-value>o-a</qti-value><qti-value>o-b</qti-value><qti-value>o-c</qti-value></qti-correct-response></qti-response-declaration><qti-outcome-declaration identifier="SCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>0</qti-value></qti-default-value></qti-outcome-declaration><qti-outcome-declaration identifier="MAXSCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>2</qti-value></qti-default-value></qti-outcome-declaration><qti-item-body xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" data-identifier="snap-order" data-title="snap-order" data-lab-editor-version="1">
              <qti-order-interaction response-identifier="RESPONSE" data-correct-response="o-a,o-b,o-c" data-score="2">
                <qti-simple-choice identifier="o-a">A</qti-simple-choice>
                <qti-simple-choice identifier="o-b">B</qti-simple-choice>
                <qti-simple-choice identifier="o-c">C</qti-simple-choice>
              </qti-order-interaction>
  ...
  it('select-point interaction: strips correct-response + score + area-mappings and mirrors to data-*', () => {
    ...
    expect(xml).toMatchInlineSnapshot(`
      "<qti-assessment-item xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.imsglobal.org/xsd/imsqtiasi_v3p0 https://purl.imsglobal.org/spec/qti/v3p0/schema/xsd/imsqti_asiv3p0p1_v1p0.xsd" identifier="snap-select-point" title="snap-select-point" adaptive="false" time-dependent="false" xml:lang="en"><qti-response-declaration identifier="RESPONSE" cardinality="single" base-type="point"><qti-correct-response><qti-value>120 80</qti-value></qti-correct-response></qti-response-declaration><qti-outcome-declaration identifier="SCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>0</qti-value></qti-default-value></qti-outcome-declaration><qti-outcome-declaration identifier="MAXSCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>2</qti-value></qti-default-value></qti-outcome-declaration><qti-item-body xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" data-identifier="snap-select-point" data-title="snap-select-point" data-lab-editor-version="1">
              <qti-select-point-interaction response-identifier="RESPONSE" max-choices="1" data-correct-response="120 80" data-score="2" data-area-mappings="{&quot;defaultValue&quot;:0,&quot;entries&quot;:[]}">
  ...
  it('choice interaction with legacy camelCase correctResponse (Phase 4 alias-deletion guard)', () => {
    ...
    expect(xml).toMatchInlineSnapshot(`
      "<qti-assessment-item xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.imsglobal.org/xsd/imsqtiasi_v3p0 https://purl.imsglobal.org/spec/qti/v3p0/schema/xsd/imsqti_asiv3p0p1_v1p0.xsd" identifier="snap-choice-legacy-camel" title="snap-choice-legacy-camel" adaptive="false" time-dependent="false" xml:lang="en"><qti-response-declaration identifier="RESPONSE" cardinality="single" base-type="identifier"/><qti-outcome-declaration identifier="SCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>0</qti-value></qti-default-value></qti-outcome-declaration><qti-outcome-declaration identifier="MAXSCORE" cardinality="single" base-type="float"><qti-default-value><qti-value>2</qti-value></qti-default-value></qti-outcome-declaration><qti-item-body xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" data-identifier="snap-choice-legacy-camel" data-title="snap-choice-legacy-camel" data-lab-editor-version="1">
              <qti-choice-interaction response-identifier="RESPONSE" correctResponse="choice-a" max-choices="1" data-correct-response="choice-a" data-score="2">
                <qti-simple-choice identifier="choice-a">A</qti-simple-choice>
                <qti-simple-choice identifier="choice-b">B</qti-simple-choice>
              </qti-choice-interaction>
            </qti-item-body><qti-response-processing><qti-response-condition><qti-response-if><qti-match><qti-variable identifier="RESPONSE"/><qti-correct identifier="RESPONSE"/></qti-match><qti-set-outcome-value identifier="SCORE"><qti-sum><qti-variable identifier="SCORE"/><qti-base-value base-type="float">2</qti-base-value></qti-sum></qti-set-outcome-value></qti-response-if></qti-response-condition></qti-response-processing></qti-assessment-item>"
