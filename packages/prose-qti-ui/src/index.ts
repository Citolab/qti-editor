...
export { QtiExtendedTextAttributesEditor } from './components/extended-text-attributes-editor/index.js';
export { QtiRubricBlockAttributesEditor } from './components/rubric-block-attributes-editor/index.js';
