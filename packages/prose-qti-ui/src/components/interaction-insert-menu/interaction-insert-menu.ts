...
import { translateQti, QtiI18nController } from '@citolab/prose-qti/components/shared';
...
import { insertGapMatchInteraction, insertGap } from '@citolab/prose-qti/components/gap-match';
