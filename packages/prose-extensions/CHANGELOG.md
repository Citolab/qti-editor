...
- [`919e693`](https://github.com/Citolab/qti-editor/commit/919e693e24fc17b5cae606c97354539d9d9d5e2f) Thanks [@denisebroekman](https://github.com/denisebroekman)! - `clearFormattingInRange` (from the new `clear-formatting` entry point) could silently no-op on the
