export * from './components/qti-gap-match-interaction/qti-gap-match-interaction.js';
export * from './components/qti-gap-match-interaction/qti-gap-match-interaction.schema.js';
