...
import type { ComposerWarning, InteractionComposeResult, InteractionResponseDeclaration, QtiAreaMapEntry } from '@citolab/prose-qti/components/shared/composer/types.js';
