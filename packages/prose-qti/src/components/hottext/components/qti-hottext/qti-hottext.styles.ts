 ...
 *
 * This used to declare `:host` from scratch and adopt one sheet where the runtime adopts two, so
 * the editor's hottext was `display: inline`, `position: static`, unaligned, and measured 129x43
