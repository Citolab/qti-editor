...
export class QtiItemsGutter extends LitElement {
  ...
  private setupEditorListeners() {
    ...
    document.addEventListener('qti:editor:ready', this.handleEditorReady as EventListener);
    console.log('[GUTTER] Scroll listener attached to:', this.scrollContainer.tagName, this.scrollContainer.className);
  }
  ...
  private handleScroll = () => {
    console.log('[GUTTER] Scroll event triggered');
  ...
  private updateCurrentItemFromScroll() {
    ...
    if (oldIndex !== currentIndex) {
      console.log('[GUTTER] Scroll detected item change:', oldIndex, '->', currentIndex);
      console.log('[GUTTER] Dispatching gutter:item-change event');
