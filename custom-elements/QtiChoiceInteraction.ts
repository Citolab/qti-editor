...
export class QtiChoiceInteraction extends ConsumerMixin(HTMLElement) {
  ...
  set maxChoices(value: number) {
    ...
    this.updateChoicesInteractionType();
  }
  ...
  private setupEventListeners() {
    this.addEventListener('choice-selected', this.handleChoiceSelected.bind(this));
  }

  private removeEventListeners() {
    this.removeEventListener('choice-selected', this.handleChoiceSelected.bind(this));
  }
