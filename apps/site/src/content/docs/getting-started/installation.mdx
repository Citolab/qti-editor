...
| `@citolab/prose-qti/decorations.css` | Styles for the opt-in editor decorators (per-choice remove, click-activated add button, settings pill) | When you also install `decoratorPluginFactories` for an interaction. |
