...
| `@citolab/prose-qti/decorations.css` | Styles for the opt-in editor decorators (hover boundary, add/remove buttons, settings pill) | When you also install `decoratorPluginFactories` for an interaction. |
