...
Every interaction ships an editor decorator (see [Choice
Interaction](/docs/qti-interactions/choice/#built-in-editor-decorations-opt-in)) and needs a second,
opt-in stylesheet on top of the mandatory one above:
