...
Add the other interactions (`extended-text`, `gap-match`, `hottext`, `inline-choice`, `match`, `order`, `select-point`, `rubric-block`) the same way — import their `qti*InteractionNodeSpec` and spread into the literal.
