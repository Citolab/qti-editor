...
The inline choice interaction is exposed as a subpath export from `@citolab/prose-qti`, so you import it from `@citolab/prose-qti/components/inline-choice` and register the custom elements with `@citolab/prose-qti/components/inline-choice/register`.
...
```ts
import '@citolab/prose-qti/components/inline-choice/register';
