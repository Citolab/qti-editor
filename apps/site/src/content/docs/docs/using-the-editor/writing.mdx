...
The QTI Editor is a rich-text editor built on [ProseMirror](https://prosemirror.net/). It supports standard document editing with a toolbar, keyboard shortcuts, and a slash command menu.
