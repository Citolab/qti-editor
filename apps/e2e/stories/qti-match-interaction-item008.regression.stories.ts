...
import sourceXML from '@qti-editor/example-items/ITEM008.xml?raw';
...
export const importItem008 = (): ProseMirrorNode =>
...
export const mountEditor = (container: HTMLElement, options: { panelEl?: HTMLElement } = {}): EditorView => {
  ...
  const view = new EditorView(container, {
    state: EditorState.create({ doc: importItem008(), schema, plugins }),
