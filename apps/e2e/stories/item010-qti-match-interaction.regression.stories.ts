/**
 * Pure-ProseMirror QTI roundtrip regression for ITEM010 (match — directedPair multiple).
 *
 *   ITEM010.xml (raw import)
...
/** Import ITEM010.xml into a ProseMirror document (raw QTI → roundtrip-xml → PM doc). */
export const importItem010 = editor.importItem;
...
const meta: Meta = {
  ...
  excludeStories: ['schema', 'importItem010', 'exportAssessmentItemDoc', 'mountEditor']
};
export default meta;

export const RoundtripItem010: StoryObj = {
  render: () => {
