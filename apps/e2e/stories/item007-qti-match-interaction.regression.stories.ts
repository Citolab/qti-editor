/**
 * Pure-ProseMirror QTI roundtrip regression for ITEM007 (match — directedPair multiple).
 *
 *   ITEM007.xml (raw import)
...
/** Import ITEM007.xml into a ProseMirror document (raw QTI → roundtrip-xml → PM doc). */
export const importItem007 = editor.importItem;
...
export const RoundtripItem007: StoryObj = {
  render: () => {
