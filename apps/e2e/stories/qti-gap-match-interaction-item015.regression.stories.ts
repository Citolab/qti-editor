/**
 * Pure-ProseMirror QTI roundtrip regression for ITEM015 (match — directedPair multiple).
 *
 *   ITEM015.xml (raw import)
 *     → qtiTransformItem().parse  (parse XML)
 *     → roundtripGapMatch            (hoist correct-response/score onto interactions)
...
import sourceXML from '@qti-editor/example-items/ITEM015.xml?raw';
...
export const RoundtripItem015: StoryObj = {
  render: () => {
