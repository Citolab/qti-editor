...
const resources = {
  en: {
    translation: {
      ...
      fileExportQtiTestXml: 'Export QTI test (XML)',
      fileExportQtiTestXmlTitle: 'Export all items as a single QTI assessment test XML (dev)',
      devMode: 'Dev mode',
  ...
  nl: {
    translation: {
      ...
      fileExportQtiTestXml: 'QTI test (XML) exporteren',
      fileExportQtiTestXmlTitle: 'Alle items exporteren als één QTI assessment test XML (dev)',
      devMode: 'Dev-modus',
