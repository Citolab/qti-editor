...
const resources = {
  en: {
    translation: {
      ...
      fileImportRoundtrip: 'Import Roundtrip XML',
      fileImportRoundtripTitle: 'Import item-body XML (dev)',
      fileExport: 'Export',
      fileExportQti: 'Export QTI XML',
      fileExportQtiTitle: 'Export as QTI XML',
      fileExportJson: 'Export JSON',
      fileExportJsonTitle: 'Export ProseMirror JSON document',
      fileExportRoundtrip: 'Export Roundtrip XML',
      fileExportRoundtripTitle: 'Export item-body XML with data-* mirrors (dev)',
      fileExportPackage: 'Export Package',
      fileExportPackageTitle: 'Export as QTI 3 package ZIP',
      fileLoad: 'Load',
  ...
  nl: {
    translation: {
      ...
      fileImportRoundtrip: 'Roundtrip XML importeren',
      fileImportRoundtripTitle: 'Item-body XML importeren (dev)',
      fileExport: 'Exporteren',
      fileExportQti: 'QTI XML exporteren',
      fileExportQtiTitle: 'Exporteren als QTI XML',
      fileExportJson: 'JSON exporteren',
      fileExportJsonTitle: 'ProseMirror JSON-document exporteren',
      fileExportRoundtrip: 'Roundtrip XML exporteren',
      fileExportRoundtripTitle: 'Item-body XML met data-* spiegels exporteren (dev)',
      fileExportPackage: 'Pakket exporteren',
      fileExportPackageTitle: 'Exporteren als QTI 3 pakket-ZIP',
      fileLoad: 'Openen',
