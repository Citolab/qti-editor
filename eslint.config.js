/**
 * ESLint Configuration for QTI Editor Monorepo
 *
...
export default [// File patterns to lint
{ files: ['**/*.{js,mjs,cjs,ts,jsx,tsx}'] }, // Global environment setup
{ languageOptions: { globals: globals.browser } }, // Base configurations - order matters!
// JavaScript best practices
pluginJs.configs.recommended, // TypeScript recommended rules
...configs.recommended, // Import/export validation
importPlugin.flatConfigs.recommended, // Lit web component rules
litConfigs['flat/recommended'], // Web Components best practices
wcConfigs['flat/recommended'], // Storybook-specific rules
...storybookConfigs['flat/recommended'], // Main configuration block
{
