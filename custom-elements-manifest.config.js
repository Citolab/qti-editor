...
const proseMirrorTags = {
  ...
  // New UI metadata tags
  pmLabel: { mappedName: "proseMirrorLabel" },
  pmIcon: { mappedName: "proseMirrorIcon" },
  pmKeywords: { mappedName: "proseMirrorKeywords" },
  pmCategory: { mappedName: "proseMirrorCategory" },
  pmInsertable: { mappedName: "proseMirrorInsertable" },
};
